...
const HeadingLevelButton = () => {
  ...
  const headings = [
    { label: 'Texto Normal', value: 0, fontSize: "16px" },
    { label: 'Encabezado 1', value: 1, fontSize: "32px" },
    { label: 'Encabezado 2', value: 2, fontSize: "24px" },
    { label: 'Encabezado 3', value: 3, fontSize: "20px" },
    { label: 'Encabezado 4', value: 4, fontSize: "18px" },
    { label: 'Encabezado 5', value: 5, fontSize: "16px" },
  ];
